...
Piping: 
The shell has the ability to perform single pipes. It creates two pipes and the appropriate file descriptors 
for them. It then closes off unnecessary ends to the pipes and connects two commands via these pipes. It allows 
for the appearence of seamless connection between two commands. Currently we do not have multiple pipes working.
