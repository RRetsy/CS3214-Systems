...
/* Replaces get_job_by_pid */
struct esh_pipeline * get_job_from_jid(int jid);

/* Gets a job by prgrp */
struct esh_pipeline * get_job_from_pgrp(pid_t pgrp);

/* Handles the kill built-in */
...
/* Handles calling the correct built-in method */
...
/*Gives terminal control to a process 
Based on snippet from FAQ*/
