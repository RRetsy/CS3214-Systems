 ...
 *
 * Modified and renamed from BaseXClient.java
 *
 * (C) Workgroup DBIS, University of Konstanz 2005-10, ISC License
 */
public class BaseXSessionSupport {
  /** Output stream. */
   ...
   */
  public BaseXSessionSupport(final String host, final int port, final String usern,
